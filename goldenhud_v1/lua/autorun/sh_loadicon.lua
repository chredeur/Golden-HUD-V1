...
ply:ChatPrint( "[GoldenHudV1 SuperAdmin Alert] Obsolete version of Golden Hud V1, Version : " ..GoldenVersion.. " , download the latest version on Github or Workshop or mtxserv resources, Version: " ..GoldenReceive )
end
end,
function( error )
